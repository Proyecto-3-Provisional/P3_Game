...
namespace magma_game
{
	...
	class EndgameFactory : public magma_engine::Factory
	{
	public:
		magma_engine::Component* createComponent(magma_engine::Entity* e);
	};

	class MinaFactory : public magma_engine::Factory
	{
	public:
		magma_engine::Component* createComponent(magma_engine::Entity* e);
	};

	class RedFactory : public magma_engine::Factory
	{
	public:
		magma_engine::Component* createComponent(magma_engine::Entity* e);
	};

	class BalaFactory : public magma_engine::Factory
	{
	public:
		magma_engine::Component* createComponent(magma_engine::Entity* e);
	};
